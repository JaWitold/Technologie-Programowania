...
import eu.jpereira.trainings.designpatterns.behavioral.chain.fakes.*;
...
public class IntegrationTest {
    ...
    public void testLogging() throws IOException, ServletException {
        ...
        filterChain.setFilters(createLoggingFilter());
    ...
    public void testAll() throws IOException, ServletException {
        ...
        assertEquals("Hello Joao :Formatted", fakeOut.getStringBuilder().toString());
    }
    ...
    public void testFormat() throws IOException, ServletException {
        ...
        // Add filters. The first added is the last to run
        filterChain.setFilters(createLoggingFilter(), createAuthorizationFilter(), createFormatFilter());
        filterChain.setTargetServlet(targetServlet);
        ...
        assertEquals("Logging: Authorized: Hello Joao :Formatted", fakeOut.getStringBuilder().toString());
    }
