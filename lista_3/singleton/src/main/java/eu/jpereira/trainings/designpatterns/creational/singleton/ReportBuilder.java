...
public class ReportBuilder {
    ...
    // Instance variables
    private Map<String, StringBuffer> sitesContents;
    ...
    private void initialize() {
        ...
        try {
            this.setSitesContents(this.siteCrawler.crawl().packSiteContens());
        ...
        if (instance == null) {
            ...
            synchronized (MUTEX) {
                if (instance == null) {
                    ...
                    System.out.println("Returning " + instance.hashCode() + " instance to Thread " + Thread.currentThread().getId());
                }
            }
        }
        return instance;
    ...
    /**
     * @param sitesContents
     *            the sitesContents to set
     */
    private void setSitesContents(Map<String, StringBuffer> sitesContents) {
        this.sitesContents = sitesContents;
    }
