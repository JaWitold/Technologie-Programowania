 ...
 *
 */
public class StartedState extends  AbstractApplianceStateBehavior {

	/**
	 * @param strategy
	 */
	public StartedState(CommunicationStrategy strategy) {
		super(strategy);
	}
	...
	public ApplianceStateBehavior stop() {
		...
		return ApplianceState.STOPPED.getStateBehavior(this.communicationStrategy);
	}
